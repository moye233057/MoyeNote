        ...
        for document in self.documents_list:
            ...
            for index,word in enumerate(document):
                if len(word) == 0 or word == '\n':
                    document.remove(document[index])
                    self.avg_documents_len = self.avg_documents_len - 1
                    continue
...
if __name__ == '__main__':
    ...
    document_list = [list(jieba.cut(doc)) for doc in textlist]
